...
@Component({
  selector: 'app-product-stock-in-report',
  templateUrl: './product-stock-in-report.component.html',
  styleUrls: ['./product-stock-in-report.component.scss']
})
export class ProductStockInReportComponent implements OnInit, OnDestroy {
